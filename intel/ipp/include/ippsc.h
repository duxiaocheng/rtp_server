...
extern "C" {
    ...
    #pragma comment( lib, __FILE__ "/../../lib/" _INTEL_PLATFORM "ippsc" )
    #pragma comment( lib, __FILE__ "/../../lib/" _INTEL_PLATFORM "ippcore" )
  #elif defined( _IPP_SEQUENTIAL_STATIC )
    #pragma comment( lib, __FILE__ "/../../lib/" _INTEL_PLATFORM "ippscmt" )
    ...
    #pragma comment( lib, __FILE__ "/../../lib/" _INTEL_PLATFORM "threaded/ippsc" )
    #pragma comment( lib, __FILE__ "/../../lib/" _INTEL_PLATFORM "threaded/ippcore" )
  #elif defined( _IPP_PARALLEL_STATIC )
    #pragma comment( lib, __FILE__ "/../../lib/" _INTEL_PLATFORM "threaded/ippscmt" )
...
typedef enum {
    IPP_PCM_LINEAR = 0,  /* uniform PCM */
    IPP_PCM_ALAW,        /* A-Law */
    IPP_PCM_MULAW   /* mu-Law */
} IppPCMLaw;
...
/*--------------------------------------------------------------------------*
 *       G.711 Appendix II parameters                                        *
 *--------------------------------------------------------------------------*/

#define G711_APPENDIX_I         1
#define REFLECTION_COEFF_SAVE   1
#define G711_DTX 1

#define IMPLEMENT_5MS_AS_10MS  /* Switch on the 5ms MIPS reducing strategy. */
#define IMPLEMENT_5MS_SID_POSTPONE
 ...
 *--------------------------------------------------------------------------*/
  ...
  *                                                                       *
  *   |--------------------|-------------|-------------|------------|     *
  *     previous speech           sf1           sf2         G711_VAD_L_NEXT        *
  *                                                                       *
  *   <----------------  Total speech vector (G711_VAD_L_TOTAL)   ----------->     *
  *   <----------------  LPC analysis window (G711_VAD_L_WINDOW)  ----------->     *
  *   |                   <-- present frame (G711_VAD_L_FRAME) -->                 *
  * old_speech            |              <-- new speech (G711_VAD_L_FRAME) -->     *
  * p_window              |              |                                *
  *                     speech           |                                *
  *                             new_speech                                *
  *-----------------------------------------------------------------------*/

#define G711_VAD_L_TOTAL     240        /* Total size of speech buffer.              */
#define G711_VAD_L_WINDOW    240        /* Window size in LP analysis.               */
#define G711_VAD_L_NEXT      40         /* Lookahead in LP analysis.                 */
#define G711_VAD_L_FRAME     80         /* Frame size.                               */

#define G711_VAD_NEW_SPEECH  (G711_VAD_L_TOTAL - G711_VAD_L_FRAME) /* New speech     */
#define G711_VAD_SPEECH      (G711_VAD_L_TOTAL - G711_VAD_L_FRAME - G711_VAD_L_NEXT)        /* Present frame  */
#define G711_VAD_P_WINDOW    (G711_VAD_L_TOTAL - G711_VAD_L_WINDOW)        /* For LPC window */

#define G711_VAD_L_SUBFR     40         /* Subframe size.                            */
#define G711_VAD_M           10         /* Order of LP filter.                       */
#define G711_VAD_MP1         (G711_VAD_M+1) /* Order of LP filter + 1                    */
#define G711_VAD_MM1         (G711_VAD_M-1) /* Order of LP filter - 1                    */
#define G711_VAD_PIT_MIN     20         /* Minimum pitch lag.                        */
#define G711_VAD_PIT_MAX     143        /* Maximum pitch lag.                        */
#define G711_VAD_PIT_MAX_4   (1+143)    /* Maximum pitch lag. multiple of 4          */
#define G711_VAD_L_INTERPOL  (10+1)     /* Length of filter for interpolation.       */
#define G711_VAD_A_1_0       4096       /* value of 1.0Q12 for filter coef A[0]      */
#define G711_VAD_GAMMA1      24576      /* Bandwitdh factor = 0.75   in Q15           */

#define G711_VAD_PRM_SIZE    11         /* Size of vector of analysis parameters.    */
#define G711_VAD_SERIAL_SIZE (80+2)     /* Bits/frame + bfi+ number of speech bits   */

#define G711_VAD_SHARPMAX    13017      /* Maximum value of pitch sharpening 0.8 Q14 */
#define G711_VAD_SHARPMIN    3277       /* Minimum value of pitch sharpening 0.2 Q14 */

#define G711_VAD_L_SUBFRP1 (G711_VAD_L_SUBFR + 1)

#define G711_VAD_GPCLIP      15564      /* Maximum pitch gain if taming is needed Q14*/
#define G711_VAD_GPCLIP2     481        /* Maximum pitch gain if taming is needed Q9 */
#define G711_VAD_GP0999      16383      /* Maximum pitch gain if taming is needed    */
#define G711_VAD_L_THRESH_ERR 983040000L /* Error threshold taming 16384. * 60000.   */

/*--------------------------------------------------------------------------*
 *       PWF constant parameters                                            *
 *--------------------------------------------------------------------------*/

#define G711_VAD_A1          4567       /*  2.23   in Q11                            */
#define G711_VAD_L_B1        3271557L   /*  0.78   in Q22                            */
#define G711_VAD_A2          11776      /*  5.75   in Q11                            */
#define G711_VAD_L_B2        16357786L  /*  3.90   in Q22                            */
#define G711_VAD_A3          27443      /* 13.40   in Q11                            */
#define G711_VAD_L_B3        46808433L  /* 11.16   in Q22                            */
#define G711_VAD_SEG1        1299       /*  0.6341 in Q11                            */
#define G711_VAD_SEG2        1815       /*  0.8864 in Q11                            */
#define G711_VAD_SEG3        1944       /*  0.9490 in Q11                            */

#define G711_VAD_THRESH_L1   -3562      /* -1.74   in Q11                            */
#define G711_VAD_THRESH_L2   -3116      /* -1.52   in Q11                            */
#define G711_VAD_THRESH_H1   1336       /*  0.65   in Q11                            */
#define G711_VAD_THRESH_H2   890        /*  0.43   in Q11                            */

#define G711_VAD_GAMMA1_0    32113      /*  0.98   in Q15                            */
#define G711_VAD_GAMMA1_1    30802      /*  0.94   in Q15                            */
#define G711_VAD_GAMMA2_0_L  13107      /*  0.40   in Q15                            */
#define G711_VAD_GAMMA2_0_H  22938      /*  0.70   in Q15                            */
#define G711_VAD_GAMMA2_1    19661      /*  0.60   in Q15                            */

#define G711_VAD_ALPHA       19302      /*  6*pi   in Q10                            */
#define G711_VAD_BETA        1024       /*     1   in Q10                            */

/*--------------------------------------------------------------------------*
 *       LTP constant parameters                                            *
 *--------------------------------------------------------------------------*/

#define G711_VAD_THRESHPIT   27853      /* Threshold to favor small pitch 0.85  Q15  */
#define G711_VAD_UP_SAMP     3          /* upsampling factor for fractional pitch    */
#define G711_VAD_L_INTER4    4          /* length/2 for interpolation filter         */
#define G711_VAD_FIR_SIZE_ANA (G711_VAD_UP_SAMP*G711_VAD_L_INTER4+1)
#define G711_VAD_L_INTER10   10         /* length/2 for interpolation filter         */
#define G711_VAD_FIR_SIZE_SYN (G711_VAD_UP_SAMP*G711_VAD_L_INTER10+1)

/*--------------------------------------------------------------------------*
 *       FCB constant parameters                                            *
 *--------------------------------------------------------------------------*/

#define G711_VAD_DIM_RR      616        /* size of correlation matrix                */
#define G711_VAD_NB_POS      8          /*                                           */
#define G711_VAD_LDEC        (G711_VAD_NB_POS + 1)
#define G711_VAD_STEP        5          /* spacing for individual pulse              */
#define G711_VAD_MSIZE       (G711_VAD_NB_POS*G711_VAD_NB_POS)
#define G711_VAD_THRESHFCB   13107      /* 0.4 in Q15                                */
#define G711_VAD_MAX_TIME    75         /* maximum number of iterations              */
#define G711_VAD_EXTRA_TIME  30         /* extra iterations for 1st subframe         */

/*--------------------------------------------------------------------------*
 *       LSP quantizer constant parameters                                  *
 *--------------------------------------------------------------------------*/

#define G711_VAD_NC          5          /* G711_VAD_NC = G711_VAD_M/2                        */
#define G711_VAD_MA_NP       4          /* MA prediction order for LSP               */
#define G711_VAD_MA_MODE     2          /* number of modes for MA prediction         */
#define G711_VAD_MA_J1       G711_VAD_MA_MODE   /* number of input vectors               */
#define G711_VAD_MA_K1       4          /* number of candidates                      */
#define G711_VAD_MA_MQ1      32         /* size of quantizer                         */
#define G711_VAD_MA_J2       4          /* number of input vectors                   */
#define G711_VAD_MA_K2       1          /* number of candidates                      */
#define G711_VAD_MA_MQ2      16         /* size of quantizer                         */
#define G711_VAD_NC0_B       7          /* number of first stage bits                */
#define G711_VAD_NC1_B       5          /* number of second stage bits               */
#define G711_VAD_NC0         (1<<G711_VAD_NC0_B)    /* number of entries in first stage  */
#define G711_VAD_NC1         (1<<G711_VAD_NC1_B)    /* number of entries in second stage */

#define G711_VAD_L_LIMIT     40          /* minimum lsf value Q13:0.005              */
#define G711_VAD_M_LIMIT     25681       /* maximum lsf value Q13:3.135              */

#define G711_VAD_GAP1        10          /* bandwidth expansion factor Q13           */
#define G711_VAD_GAP2        5           /* bandwidth expansion factor Q13           */
#define G711_VAD_GAP3        321         /* bandwidth expansion factor Q13           */
#define G711_VAD_GRID_POINTS 50       /* search a_grid                             */
#define G711_VAD_INTERVALS  2         /* intervals of binary search                */

#define G711_VAD_PI04        ((Word16)1029)         /* Q13  pi*0.04                  */
#define G711_VAD_PI92        ((Word16)23677)        /* Q13  pi*0.92                  */
#define G711_VAD_CONST10     ((Word16)10*(1<<11))   /* Q11  10.0                     */
#define G711_VAD_CONST12     ((Word16)19661)        /* Q14  1.2                      */

/* Array sizes */
#define G711_VAD_MEM_RES2    (G711_VAD_PIT_MAX + 1 + G711_VAD_LH_UP_L)
#define G711_VAD_SIZ_RES2    (G711_VAD_MEM_RES2 + G711_VAD_L_SUBFR)
#define G711_VAD_SIZ_Y_UP    ((G711_VAD_F_UP_PST-1) * G711_VAD_L_SUBFRP1)
#define G711_VAD_SIZ_TAB_HUP_L ((G711_VAD_F_UP_PST-1) * G711_VAD_LH2_L)
#define G711_VAD_SIZ_TAB_HUP_S ((G711_VAD_F_UP_PST-1) * G711_VAD_LH2_S)
...
#define G711_VAD_NCODE1_B  3            /* number of Codebook-bit                    */
#define G711_VAD_NCODE2_B  4            /* number of Codebook-bit                    */
#define G711_VAD_NCODE1    (1<<G711_VAD_NCODE1_B)   /* Codebook 1 size                   */
#define G711_VAD_NCODE2    (1<<G711_VAD_NCODE2_B)   /* Codebook 2 size                   */
#define G711_VAD_NCAN1     4            /* Pre-selecting order for #1                */
#define G711_VAD_NCAN2     8            /* Pre-selecting order for #2                */
#define G711_VAD_INV_COEF  -17103       /* Q19                                       */
...
#define G711_VAD_GAMMA1_PST  22938      /* denominator weighting factor   (Q15)      */
#define G711_VAD_GAMMA2_PST  18022      /* numerator  weighting factor (Q15)         */
#define G711_VAD_LONG_H_ST   20         /* impulse response length                   */
#define G711_VAD_GAMMA3_PLUS 6554       /* tilt weighting factor when k1>0 (Q15)     */
#define G711_VAD_GAMMA3_MINUS 29491     /* tilt weighting factor when k1<0 (Q15)     */

/* long term pst parameters :                                               */
#define G711_VAD_F_UP_PST    8          /* resolution for fractional delay           */
#define G711_VAD_LH2_S       4          /* length of short interp. subfilters        */
#define G711_VAD_L2_LH2_L    4          /* log2(G711_VAD_LH2_L)                          */
#define G711_VAD_LH2_L       (1 << G711_VAD_L2_LH2_L)
#define G711_VAD_MIN_GPLT    21845      /* LT gain minimum (Q15)                     */

#define G711_VAD_LH_UP_S     (G711_VAD_LH2_S/2)
#define G711_VAD_LH_UP_SM1   (G711_VAD_LH_UP_S-1)
#define G711_VAD_LH_UP_L     (G711_VAD_LH2_L/2)
#define G711_VAD_LH2_L_P1    (G711_VAD_LH2_L + 1)
...
#define G711_VAD_OCTET_TX_MODE
#define G711_VAD_RATE_SID_OCTET  16     /* number of bits in Octet Transmission mode */

/*--------------------------------------------------------------------------*
 * VAD constants                                                            *
 *--------------------------------------------------------------------------*/

#define G711_VAD_NP             12      /* Increased LPC order */
#define G711_VAD_NOISE          0
#define G711_VAD_VOICE          1
#define G711_VAD_INIT_FRAME     32
#define G711_VAD_INIT_COUNT     20
#define G711_VAD_ZC_START       120
#define G711_VAD_ZC_END         200

/* DTX constants */
#define G711_VAD_FLAG_COD       1
#define G711_VAD_FLAG_DEC       0
#define G711_VAD_INIT_SEED      11111
#define G711_VAD_FR_SID_MIN     3
#define G711_VAD_NB_SUMACF      3
#define G711_VAD_NB_CURACF      2
#define G711_VAD_NB_GAIN        2
#define G711_VAD_FRAC_THRESH1   4855
#define G711_VAD_FRAC_THRESH2   3161
#define G711_VAD_A_GAIN0        28672

#define G711_VAD_SIZ_SUMACF     (G711_VAD_NB_SUMACF * G711_VAD_MP1)
#define G711_VAD_SIZ_ACF        (G711_VAD_NB_CURACF * G711_VAD_MP1)
#define G711_VAD_A_GAIN1        4096    /* 32768L - G711_VAD_A_GAIN0 */

#define G711_VAD_RATE_8000      80      /* Full rate  (8000 bit/s)       */
#define G711_VAD_RATE_SID       15      /* SID                           */
#define G711_VAD_RATE_0         0       /* 0 bit/s rate                  */

/* CNG excitation generation constant */
                                        /* alpha = 0.5 */
#define G711_VAD_FRAC1          19043   /* (sqrt(40)xalpha/2 - 1) * 32768 */
#define G711_VAD_K0             24576   /* (1 - alpha ** 2) in Q15        */
#define G711_VAD_G_MAX          5000
#define G711_VAD_R_LSFQ         10

#define G711_VAD_1_2    (Word16)(16384)
#define G711_VAD_1_4    (Word16)( 8192)
#define G711_VAD_1_8    (Word16)( 4096)
#define G711_VAD_1_16   (Word16)( 2048)

/*--------------------------------------------------------------------------*
 * Bitstream constants                                                      *
 *--------------------------------------------------------------------------*/

#define G711_VAD_BIT_0       0x007f /* definition of zero-bit in bit-stream      */
#define G711_VAD_BIT_1       0x0081 /* definition of one-bit in bit-stream       */
#define G711_VAD_SYNC_WORD   0x6b21 /* definition of frame erasure flag          */
#define G711_VAD_SIZE_WORD   80     /* number of speech bits                     */

/*--------------------------------------------------------------------------*
 *       G.711 Appendix II parameters                                        *
 *--------------------------------------------------------------------------*/

#define G711_L_WINDOW           200             /* 25 ms window */
#define G711A2_FRAME_SIZE       80
#define G711_NP                 4               /* G711_NP MUST BE EVEN     */
#define G711_MP1                (G711_NP+1)     /* Order of LP filter + 1   */
#define G711_MM1                (G711_NP-1)     /* Order of LP filter - 1   */
#define g711_M                  4
...
#define G711_ANNEX2 1

/* Control word encode bit definitions. */
#define G711_NOTX_COUNT_MASK    0xff00      /* Byte for NoTX count. */
#define G711_NOTX_COUNT_SHIFT   8           /* Number of shifts to get count at bit 0. */
#define G711_5MS                (0<<2)
#define G711_10MS               (1<<2)
#define G711_20MS               (2<<2)
#define G711_30MS               (3<<2)
#define G711_FRAME_SIZE_MASK    (3<<2)
/* 1000 mS before sending another SID (50 * 20 mS). */
#define G711_DEFAULT_DURATION      50

/* Control/status word shared bit definitions. */
#define G711_RESET_ENABLE       0x0080      /* Coder/decoder Reset bit */
#define G711_NO_EXIT            0x0040      /* Coder/decoder Exit immediately bit */
#define G711_DTX_ENABLE         0x0020      /* Encoder Enable TxDTX/VAD */
/* Bottom two bits of control word */
#define G711_FRAME_NOTX     0          /* No transmission. */
#define G711_FRAME_ACTIVE   1          /* Active (voice). */
#define G711_FRAME_SID      2          /* SID (Silence Insertion Descriptor). */
#define G711_FRAME_PLC      3          /* Packet Loss Concealment required. */
#define G711_FRAME_MASK     3          /* Mask for frame type bits. */
/* Control word decode bit definitions. */
#define G711_RX_PLC_ENABLE      0x0010      /* Decoder PLC Enable */
#define G711_L_WINDOW           200             /* 25 ms window */
#define G711A2_FRAME_SIZE       80
#define G711_NP                 4               /* G711_NP MUST BE EVEN     */
#define G711_MP1                (G711_NP+1)     /* Order of LP filter + 1   */
...
/* Control word decode bit definitions. */
#define G711_RX_PLC_ENABLE          0x0010  /* Decoder PLC Enable */
#define G711_RX_PLC_NO_DELAY_ENABLE 0x0100  /* Decoder PLC No Delay Enable */
/* G.711 PLC (Appendix I) defines. */
#define LOWCOMPLEXPITCH             /* define to use low complexity pitch search routine */
...
#define FRAMESZ         80          /* 10 msec at  8  KHz ***NOTE: HAS TO BE EVEN and >=64!!!*/
#define SILCNT          5           /* number of erasured frames after which output is silent*/
                                    /* this should not be changed since the ATTENFAC assumes a
                                    factor of approximately 0.20 per frame */

/* fixed point factors */

#define Q11             2048        /* value 1.00 in Q.11          */
#define Q10             1024        /* value 1.00 in Q.10          */
#define Q9              512         /* value 1.00 in Q.9          */
#define Q7              128         /* value 1.00 in Q.7          */
#define Q4              16          /* value 1.00 in Q.4           */


#define ATTENFAC        200         /* attenuation factor per 10 ms frame in Q.10
                                    * which should be approximately 1/SILCNT but <= 1/SILCNT and
                                    should be a multiple of (FRAMESZ/2) */

/* dependent values */

#define ATTENINCR   (ATTENFAC/(FRAMESZ/2))    /* attenuation per 2 samples, should be
...
/* pitch search algorithm dependent values */

#define CORRMINPOWER    250                 /* minimum power */

#define MAX_DEC_CORR_NUM  ((PITCHDIFF)/(NDEC)+4)                // maximal number of correlations computed in findpitchnew procedure
#define MIN_FRAME_SIZE    40                                    // 5ms frame is currently minimal one
#define MAX_FRAME_NUM_PER_CORRLEN    (CORRLEN/MIN_FRAME_SIZE)   // maximal number of frames per CORRLEN
...
typedef struct {
    Ipp16s    history[HISTORYLEN];    /* history buffer (can be circular) */
    Ipp32s    erasecnt;               /* consecutive erased frames (also provides quad-word alignment for next variable) */
    Ipp16s    pitchbuf[HISTORYLEN];   /* buffer for cycles of speech */
    Ipp32s    pitch;                  /* pitch estimate (also provides quad-word alignment for next variable) */
    Ipp16s    lastq[POVERLAPMAX];     /* saved last quarter wavelength */
    Ipp32s    poverlap;               /* overlap based on pitch */
    Ipp32s    overlapinc;             /* Q.11 increment in overlap factor */
    Ipp32s    poffset;                /* offset Word32o pitch period */
    Ipp32s    pitchblen;              /* current pitch buffer length */
    Ipp16s    pitchbufstartindex;     /* start of pitch  buffer */
    Ipp16s    use_no_delay;       /* If set, use zero delay algorithm. */
} PlcState;
...
struct _G711Decoder_Obj {
    ...
    Ipp16s outBytes;    /* Number of bytes to be outputted by decoder (based on frame size). */
    /* Variables for Appendix II (VAD). */
    Ipp16s QuantKBufDec[G711_NP+1];
    Ipp16s GA2D_SyntIirDl[G711_NP+1];
    Ipp16s DecLogR0inDbOl;
    Ipp16s GA2seed;
    Ipp16s saved_5_frame[G711_VAD_L_FRAME/2];
    Ipp16s saved_5;
    Ipp16s status_word;
};
...
struct _G711Encoder_Obj {
    ...
    /* New items for VAD. */
    Ipp16s old_speech[G711_VAD_L_TOTAL];
    Ipp32s y[2];
    Ipp16s x[2];
    Ipp16s past_qua_en[4];
    Ipp16s old_A[G711_VAD_M];
    Ipp16s old_rc[2];
    Ipp16s lsp_old[G711_VAD_M];      /* unquantized Lsp (Line spectral pairs) */
    Ipp16s MeanLSF[G711_VAD_M];      /* vad variable */
    Ipp16s Min_buffer[16];  /* vad variable */
    Ipp16s cod_freq_prev[G711_VAD_MA_NP][G711_VAD_M];      /* Q13:previous LSP vector       */
    Ipp16s ener[G711_VAD_NB_GAIN];
    Ipp16s sh_ener[G711_VAD_NB_GAIN];      /* G711_VAD_NB_GAIN = 2 */
    Ipp16s Acf[G711_VAD_SIZ_ACF];
    Ipp16s sh_Acf[G711_VAD_NB_CURACF];    /* G711_VAD_NB_CURACF = 2 */
    Ipp16s pastCoeff[G711_VAD_MP1];
    Ipp16s RCoeff[G711_VAD_MP1];
    Ipp16s sh_RCoeff;
    Ipp16s sumAcf[G711_VAD_SIZ_SUMACF];
    Ipp16s sh_sumAcf[G711_VAD_NB_SUMACF];
    Ipp16s fr_cur;
    Ipp16s nb_ener;
    Ipp16s flag_chang;
    Ipp16s prev_energy;
    ...
    Ipp16s input10[G711_VAD_L_FRAME];
    ...
    /* Variables for G.711 Appendix II */
    Ipp16s g711_rc[G711_VAD_M];
    Ipp16s FrameType;
    Ipp16s LogR0inDbOl;
    Ipp16s QuantKBuf[G711_NP];
    Ipp16s LogR0;
    Ipp16s prevg711frametype;
    Ipp16s AutoCorrExp;
    Ipp16s FrameE;
    Ipp16s notx_count;

    Ipp16s notx_duration;   /* Counts before forcing a SID to be emitted. */

#if 1 /* add extra VAD hangover to improve voice quality */
    Ipp16s vad_hangover_count;
    Ipp16s vad_hangover_thr;
    Ipp16s lastVad;
#endif

    /* Variables for 5ms frame sizes */
    Ipp16s framesize;
    Ipp16s skip_CNG;
    Ipp16s postcalc_SID;
#ifdef IMPLEMENT_5MS_AS_10MS
    Ipp16s skip_this_5ms_frame;
    Ipp16s previous_5ms_decision;
#endif
};
...
#if !defined( __PVSDK_VERSION_H__ )
#define __PVSDK_VERSION_H__

#define PVSDK_VERSION_MAJOR  1
#define PVSDK_VERSION_MINOR  5
#define PVSDK_VERSION_UPDATE 0

#define PVSDK_VERSION_STR "PVSDK 1.5.0"

#endif /* __PVSDK_VERSION_H__ */

typedef struct {
    int    major;                     /* e.g. 1                               */
    int    minor;                     /* e.g. 2                               */
    int    majorBuild;                /* e.g. 3                               */
    const char* extension;            /* e.g. "e"                               */
    const char* Version_str;          /* e.g. "v1.2 Beta"                     */
    const char* BuildDate;            /* e.g. "Jul 20 99"                     */
} pvsdk_Version;

/* /////////////////////////////////////////////////////////////////////////////
//  Name:        pvsdkGetLibVersion
//  Purpose:     getting of the PVSDK version
...
*/
const pvsdk_Version* pvsdkGetVersion(void);
...
IPPAPI( IppStatus, ippsAutoCorr_NormE_NR_local_16s, (const Ipp16s *pSrc, int len, Ipp16s *pDst,
       int lenDst, int *pNorm) )
...
IPPAPI( IppStatus, ippsResidualFilter_G729_16s_amr_sat, ( const Ipp16s * pSrc, const Ipp16s * pSrcLPC,
        Ipp16s * pDst) )
...
IPPAPI(IppStatus,ippsAG_SC_G711_dofe,(Ipp16s *out,
    PlcState *plc_st,
    Ipp16s framesize))

IPPAPI(Ipp32s,ippsAG_SC_g711_vade,(G711Encoder_Obj* encoderObj,
    const Ipp16s *src,
    Ipp8s *dst,
    Ipp32s *frametype))

IPPAPI(void,ippsAG_SC_g711_vade_SID,(G711Encoder_Obj *encoderObj, Ipp8s *dst))

IPPAPI(IppStatus,ippsAG_SC_G711_plc_init,(PlcState *plc_st))

IPPAPI(IppStatus,ippsAG_SC_G711_a2decoder,(G711Decoder_Obj *DecObj,
    Ipp16s *g711_dec_in_buffer,
    Ipp16s frame_type,
    Ipp16s *out_buffer))

IPPAPI(IppStatus,ippsAG_SC_G711_addtohistory,(Ipp16s *s,
    PlcState *plc_st))

IPPAPI(IppStatus,ippsAG_SC_G711_addtohistory5,(Ipp16s *s,
    PlcState *plc_st))

IPPAPI(IppStatus,ippsg711_vade_init,(G711Encoder_Obj* encoderObj, Ipp16s framesize))

IPPAPI(Ipp16s,ippsAG_SC_G711_Cod_cng,(G711Encoder_Obj* encoderObj))
...
IPPAPI( IppStatus, ippsSynthesisFilter_NR_local_16s_Sfs, (const Ipp16s * pLPC, const Ipp16s * pSrc,
        Ipp16s * pDst, int len, int scaleFactor, const Ipp16s *pMem) )
...
IPPAPI( IppStatus, ippsSynthesisFilterLow_NR_16s_ISfs_amr_sat, (const Ipp16s * pLPC, Ipp16s * pSrcDst,
       int len, int scaleFactor, const Ipp16s *pMem) )
...
IPPAPI(IppStatus, ippsConvPartial_16s_Sfs_amr_sat,
       ( const Ipp16s* pSrc1, const Ipp16s* pSrc2,  Ipp16s* pDst, int len, int scaleFactor) )
...
IPPAPI( IppStatus, ippsDecodeAdaptiveVector_G729_local_16s_I,(const Ipp16s * pSrcDelay,
       Ipp16s * pSrcDstPrevExcitation))
...
IPPAPI(IppStatus,ippsAdaptiveCodebookContribution_G729_local_16s, (Ipp16s gain,
       const Ipp16s *pFltAdptVector, const Ipp16s *pSrcAdptTarget, Ipp16s* pDstAdptTarget))
...
IPPAPI(IppStatus, ippsGainQuant_G729_local_16s, (
       const Ipp16s *pSrcAdptTarget, const Ipp16s *pSrcFltAdptVector,
       const Ipp16s * pSrcFixedVector, const Ipp16s *pSrcFltFixedVector,
       Ipp16s *pSrcDstEnergyErr, Ipp16s *pDstQGain, Ipp16s *pDstQGainIndex, Ipp16s tameProcess))
...
IPPAPI( IppStatus, ippsPreemphasize_G729A_16s_I_amr_sat, (Ipp16s gamma, Ipp16s *pSrcDst, int len,
       Ipp16s* pMem) )
...
IPPAPI(IppStatus,ippsLevinsonDurbin_G729_local_32s16s,( const Ipp32s * pSrcAutoCorr,
       int order, Ipp16s * pDstLPC, Ipp16s * pDstRc, Ipp16s * pResultResidualEnergy))
...
IPPAPI(IppStatus,ippsLevinsonDurbin_G729B_local,(const Ipp32s * pSrcAutoCorr,
       Ipp16s * pDstLPC, Ipp16s * pDstRc, Ipp16s * pResultResidualEnergy))
...
IPPAPI( IppStatus, ippsAdaptiveCodebookSearch_G729_local_16s, (Ipp16s valOpenDelay,
        const Ipp16s * pSrcAdptTarget, const Ipp16s * pSrcImpulseResponse,
        Ipp16s * pSrcDstPrevExcitation, Ipp16s * pDstDelay,
        Ipp16s * pDstAdptVector, Ipp16s subFrame))
...
IPPAPI( IppStatus, ippsAdaptiveCodebookSearch_G729A_local_16s, (Ipp16s valOpenDelay,
        const Ipp16s * pSrcAdptTarget, const Ipp16s * pSrcImpulseResponse,
        Ipp16s * pSrcDstPrevExcitation, Ipp16s * pDstDelay,
        Ipp16s * pDstAdptVector, Ipp16s subFrame))
...
IPPAPI( IppStatus, ippsAdaptiveCodebookGain_G729_local_16s, (const Ipp16s * pSrcAdptTarget,
       const Ipp16s * pSrcImpulseResponse, const Ipp16s * pSrcAdptVector,
       Ipp16s * pDstFltAdptVector, Ipp16s * pResultAdptGain))	   
...
IPPAPI( IppStatus, ippsAdaptiveCodebookGain_G729A_local_16s, (const Ipp16s * pSrcAdptTarget,
       const Ipp16s * pSrcLPC, const Ipp16s * pSrcAdptVector, Ipp16s * pDstFltAdptVector,
       Ipp16s * pResultAdptGain))
...
/* /////////////////////////////////////////////////////////////////////////////
// Name:       ipps_Q_plsf_5_GSMEFR_16s
//
// Purpose:     - Quantization of 2 sets of LSF parameters, using
//                      1st order MA prediction and split by 5 matrix
//                       quantization (split-MQ).
// past_rq      - Pointer to the unquantized vector, represented using Q0.15. 
// lsp1  		- Pointer to 1st LSP vector, represented using Q0.15.
// lsp2     	- Pointer to 2nd LSP vector, represented using Q0.15. 
// lsp_mid_q 	- Pointer to quantized 1st LSP vector, represented using Q0.15.
// lsp_new_q    - Pointer to quantized 2nd LSP vector, represented using Q0.15.
// txdtx_ctrl   - Used to indicate the EFR tx flag
// tmpEFRP		- Pointer to pointer of some EFR state variables needed
//  Returns:    IppStatus
//      ippStsNoErr          if no error
*/

IPPAPI(IppStatus, ipps_Q_plsf_5_GSMEFR_16s, (Ipp16s *past_rq, const Ipp16s *lsp1, const Ipp16s *lsp2,
                  Ipp16s *lsp_mid_q, Ipp16s *lsp_new_q, Ipp16s *indice,
                  Ipp16s txdtx_ctrl, Ipp16s **tmpEFRP ))
...
/* /////////////////////////////////////////////////////////////////////////////
//  Name:   ippsAlgebraicCodebookSearchGetBufferSize_GSMAMR
//
//  Purpose:   Get the size (in bytes) of the buffer for ippsAlgebraicCodebookSearchEX_GSMAMR internal calculations.
//
//  Arguments:
...
IPPAPI(IppStatus, ippsAlgebraicCodebookSearchGetBufferSize_GSMAMR_16s,(int *pBufferSize ))
...
//    pSrcDstImpulseResponse  - Impulse response of weighted synthesis filter. h[-L_subfr..-1] must be set to zero.
...
//    ippStsRangeErr   - Error when :
//                         The subFrame value isn't in range [0..3].
//                         The valIntPitchLag value isn't in range [17..144].
//                         The mode value isn't supported bitrate.
*/
...
IPPAPI(IppStatus, ippsAlgebraicCodebookSearchEX_GSMAMR_16s,
      (Ipp16s   valIntPitchLag,   Ipp16s valBoundQAdptGain,
       ...
       Ipp16s subFrame, IppSpchBitRate mode, Ipp8u* pBuffer))
/* /////////////////////////////////////////////////////////////////////////////
...
/* /////////////////////////////////////////////////////////////////////////////
//  Name:        ippsEncodeBitrate_G726
//  Purpose:       Changes the bitrate for the ADPCM encode
//  Parameters:
//    pEncMem      Pointer to the input memory buffer of appropriate size applicable to
//                 store a state of the encoder
//    rate         Encode bit rate of the G.726 encoder: IPP_SPCHBR_16000,
...
IPPAPI(IppStatus, ippsEncodeBitrate_G726_16s8u,
       (IppsEncoderState_G726_16s* pEncMem, IppSpchBitRate rate))       
/* /////////////////////////////////////////////////////////////////////////////
...
IPPAPI(IppStatus, ippsDecodeBitrate_G726_8u16s,
       (IppsDecoderState_G726_16s* pDecMem, IppSpchBitRate rate))       
/* /////////////////////////////////////////////////////////////////////////////
...
IPPAPI(IppStatus, ippsDecode_G726_8u16s,
       (IppsDecoderState_G726_16s* pDecMem, const Ipp8u *pSrc, void *pDst, unsigned int len))
/* /////////////////////////////////////////////////////////////////////////////
//                               G.726 end
///////////////////////////////////////////////////////////////////////////// */
...
/* /////////////////////////////////////////////////////////////////////////////
//  Name:   ippsAlgebraicCodebookSearchGetBufferSize_AMRWB
//
//  Purpose:   Get the size (in bytes) of the buffer for ippsAlgebraicCodebookSearchEX_AMRWB internal calculations.
//
//  Arguments:
//     pBufferSize   - Pointer to the calculated buffer size (in bytes).
//  Return:
...
IPPAPI(IppStatus, ippsAlgebraicCodebookSearchGetBufferSize_AMRWB_16s,(int *pBufferSize ))
...
//      ippStsNoErr         if no error
*/
IPPAPI(IppStatus, ippsAlgebraicCodebookSearch_AMRWB_16s,(const Ipp16s *pSrcFixedTarget, const Ipp16s *pSrcLtpResidual, 
   Ipp16s *pSrcDstImpulseResponse, Ipp16s *pDstFixedVector, Ipp16s *pDstFltFixedVector, IppSpchBitRate mode, Ipp16s *pDstIndex ))


IPPAPI(IppStatus, ippsAlgebraicCodebookSearchEX_AMRWB_16s,(const Ipp16s *pSrcFixedTarget, const Ipp16s *pSrcLtpResidual, 
   Ipp16s *pSrcDstImpulseResponse, Ipp16s *pDstFixedVector, Ipp16s *pDstFltFixedVector, IppSpchBitRate mode, Ipp16s *pDstIndex, Ipp8u *pBuffer ))
...
/* /////////////////////////////////////////////////////////////////////////////
//  Name:   ippsUpsampleGetBufferSize_AMRWBE
//
//  Purpose:   Get the size (in bytes) of the buffer for ippsUpsampleEX_AMRWBE_16s internal calculations.
//
//  Arguments:
//     pBufferSize   - Pointer to the calculated buffer size (in bytes).
//  Return:
...
IPPAPI(IppStatus, ippsUpsampleGetBufferSize_AMRWBE_16s,(int *pBufferSize ))
...
//      ippStsNoErr          if no error
*/
IPP_DEPRECATED("is deprecated. This function is obsolete and will be removed in one of the future IPP releases. Use ippsUpsampleEX_AMRWBE_16s function instead of this one and the following link for details: https://software.intel.com/sites/products/ipp-deprecated-features-feedback/")\
...
IPPAPI(IppStatus, ippsUpsampleEX_AMRWBE_16s, (const Ipp16s* pSrcSignal,
       Ipp16s* pSrcDstSignal, int lenDst, Ipp16s* pMem, Ipp32s bandIdx, Ipp32s addFlag, Ipp8u* pBuffer))
...
/* For EVS Encoder API*/
#define Intel_EVS_Encoder_Init            ippsIntel_EVS_Encoder_Init
#define Intel_EVS_Encoder_GetStatus       ippsIntel_EVS_Encoder_GetStatus
#define Intel_EVS_Encoder_GetControl      ippsIntel_EVS_Encoder_GetControl
#define Intel_EVS_Encoder_Set_Params      ippsIntel_EVS_Encoder_Set_Params
#define Intel_EVS_Encoder_Exec            ippsIntel_EVS_Encoder_Exec

#ifndef _INTEL_EVS_ENCODER_API_H_
#define _INTEL_EVS_ENCODER_API_H_

#define UWord16           Ipp16u
#define Word16            Ipp16s
#define Word32            Ipp32s
#define UWord32           Ipp32u
#define Word8             Ipp8s
#define UWord8            Ipp8u

#ifndef INDICE_FX_STRUCT
#define INDICE_FX_STRUCT
typedef struct
{
...
#define EVS_UPDATE_BRATE    0x01
#define EVS_UPDATE_BWIDTH   0x02

/* Structure for EVS encoder control parameters*/
typedef struct
{
    ...
    Word16 brate_bw_update;                     /* = 1 if bit rate needs to be updated */
} Intel_EVS_Encoder_Cntrl_t;

/* Structure for EVS encoder status parameters*/
typedef struct
{
    Word32 total_brate_fx_in_use;               /* total bitrate in kbps of the codec */
    Word16 Opt_AMR_WB_fx;                       /* flag indicating AMR-WB IO mode */
    Word16 Opt_RF_ON;
    Word16 interval_SID_fx;                     /* CNG and DTX - interval of SID update, default 8 */
    ...
    Word16 nb_bits_tot_fx;                      /* total number of bits already written in a frame*/
    Word16 bwidth_in_use;                       /* Band width used currently */
    Word16 core_in_use;                         /* core/technology used in encoder */
} Intel_EVS_Encoder_Status_t;
#endif /* _INTEL_EVS_ENCODER_API_H_ */


IPPAPI(Word32, ippsIntel_EVS_Encoder_Init, (
    void *pCntxt,                            /* i/o: Encoder static variables structure  */
    Intel_EVS_Encoder_Cntrl_t *pEnCntrl
    ))

IPPAPI(UWord16, ippsIntel_EVS_Encoder_GetStatus, (
    void *pCntxt,
    Intel_EVS_Encoder_Status_t *pEnStatus
    ))

IPPAPI(UWord16, ippsIntel_EVS_Encoder_GetControl, (
    void *pCntxt,
    Intel_EVS_Encoder_Cntrl_t *pEnCntrl
    ))

IPPAPI(UWord16, ippsIntel_EVS_Encoder_Set_Params, (
    void *pCntxt,
    Intel_EVS_Encoder_Cntrl_t *pEnCntrl
    ))
...
/* For EVS Decoder API */
#define Intel_EVS_Decoder_Init            ippsIntel_EVS_Decoder_Init
#define Intel_EVS_Decoder_GetStatus       ippsIntel_EVS_Decoder_GetStatus
#define Intel_EVS_Decoder_GetControl      ippsIntel_EVS_Decoder_GetControl
#define Intel_EVS_Decoder_Set_Params      ippsIntel_EVS_Decoder_Set_Params
#define Intel_EVS_Decoder_Exec            ippsIntel_EVS_Decoder_Exec
#define Intel_EVS_Decoder_JB_Init		  ippsIntel_EVS_Decoder_JB_Init
#define Intel_EVS_Decoder_JB_GetSize	  ippsIntel_EVS_Decoder_JB_GetSize
#define Intel_EVS_Decoder_JB_FeedFrame	  ippsIntel_EVS_Decoder_JB_FeedFrame
#define Intel_EVS_Decoder_JB_GetSamples	  ippsIntel_EVS_Decoder_JB_GetSamples

#ifndef _INTEL_EVS_DECODER_API_H_
#define _INTEL_EVS_DECODER_API_H_
...
/* Structure for EVS decoder control parameters*/
typedef struct Intel_EVS_Decoder_Cntrl
{
    ...
    Word16 sti_flag;                                    /* STI (SID type indicator) bit, for AMRWBIO and MIME only*/
    Word16 bitstreamformat;                             /* Bitstream format flag (G.192/MIME/RTP) */
    Word16 amrwb_rfc4867_flag;                          /* MIME from rfc4867 is used, for AMRWB */
    Word16 isAMRWB_IOmode;
    Word16 use_partial_copy;                            /* partial frame information, voip only     */
    Word16 next_coder_type;                             /* next coder type information, voip only     */
    Word16 core_mode;
	Word16 jbmTrace_enable;								/* flag to enable JBM trace */
} Intel_EVS_Decoder_Cntrl_t;

/* Structure for EVS decoder status parameters*/
typedef struct Intel_EVS_Decoder_Status
{
    Word16 codec_mode;                                  /* MODE1 or MODE2 */
    Word16 bfi_fx;                                      /* FEC - bad frame indicator */
    //Word32 total_brate_fx;                            /* total bitrate in kbps of the codec Q0*/
    ...
    Word32 num_frame_processed;                         /* number of frame processed so far*/
    /* parameters needed for DTX handler*/
	...
	Word16 fec_offset;
	Word16 jbIsEmpty;
	unsigned char	jbmTraceBuf[256];
} Intel_EVS_Decoder_Status_t;
#endif /* _INTEL_EVS_DECODER_API_H_ */

IPPAPI(Word32, ippsIntel_EVS_Decoder_Init, (
    void *pCntxt,                            /* i/o: Decoder static variables structure  */
    Intel_EVS_Decoder_Cntrl_t *pDeCntrl
    ))
IPPAPI(UWord16, ippsIntel_EVS_Decoder_Set_Params, (
    void *pCntxt,
    Intel_EVS_Decoder_Cntrl_t *pEnCntrl
    ))
...
IPPAPI(UWord16, ippsIntel_EVS_Decoder_GetStatus, (
    void *pCntxt,
    Intel_EVS_Decoder_Status_t *pDeStatus
    ))
IPPAPI(UWord16, ippsIntel_EVS_Decoder_GetControl, (
    void *pCntxt,
    Intel_EVS_Decoder_Cntrl_t *pDeCntrl
    ))
IPPAPI(Word32, ippsIntel_EVS_Decoder_JB_GetSize, (
	void
	))
IPPAPI(Word32, ippsIntel_EVS_Decoder_JB_Init, (
	void *hJB,
	void *pCntxt,
	Intel_EVS_Decoder_Cntrl_t *pDeCntrl
	))
IPPAPI(Word32, ippsIntel_EVS_Decoder_JB_FeedFrame, (
	void *hJB,
	RTP_Frame *pRTP_frame
	))
IPPAPI(Word32, ippsIntel_EVS_Decoder_JB_GetSamples, (
	void *hJB,
	Word16 *ptr_nSamples,
	Word16 *pcmBuf,
	Word16 pcmBufSize,
	Word32 systemTime_ms,
	Intel_EVS_Decoder_Cntrl_t *pDeCntrl,
	Intel_EVS_Decoder_Status_t *pDeStatus
	))
...
#ifndef _INTEL_OPUS_API_H_
#define _INTEL_OPUS_API_H_
...
#define opus_val16      Ipp16s
#define opus_val32      Ipp32s
#define opus_int16      Ipp16s
#define opus_uint16     Ipp16u
#define opus_int32      Ipp32s
#define opus_uint32     Ipp32u
#ifndef opus_int64
#define opus_int64      Ipp64s
#endif /* opus_int64 */
#ifndef opus_int8
#define opus_int8       Ipp8s
#endif /* opus_int8 */
#ifndef opus_uint8
#define opus_uint8      Ipp8u
#endif /* opus_uint8 */
#define opus_int        int
...
IPPAPI(int, ippsIntel_opus_decode, (
    OpusDecoder *st,
...
IPPAPI(opus_int32, ippsIntel_opus_encode, (
    OpusEncoder *st,
...
IPPAPI(int, ippsIntel_opus_encoder_ctl_int32, (
    OpusEncoder *st, 
    int request,
    opus_int32 value))

IPPAPI(int, ippsIntel_opus_encoder_ctl_int32Ptr, (
    OpusEncoder *st, 
    int request,
    opus_int32 *value))

IPPAPI(int, ippsIntel_opus_encoder_ctl_uint32Ptr, (
    OpusEncoder *st, 
    int request,
    opus_uint32 *value))

#if 0 //for future enabling
IPPAPI(int, ippsIntel_opus_encoder_ctl_int16Ptr, (
    OpusEncoder *st, 
    int request,
    opus_val16 *value))

IPPAPI(int, ippsIntel_opus_encoder_ctl_noarg, (
    OpusEncoder *st, 
    int request))


IPPAPI(int, ippsIntel_opus_decoder_ctl_int32, (
    OpusDecoder *st, 
    int request,
    opus_int32 value))

IPPAPI(int, ippsIntel_opus_decoder_ctl_int32Ptr, (
    OpusDecoder *st, 
    int request,
    opus_int32 *value))

IPPAPI(int, ippsIntel_opus_decoder_ctl_noarg, (
    OpusDecoder *st, 
    int request))

#endif

IPPAPI(int, ippsIntel_opus_decoder_ctl_uint32Ptr, (
    OpusDecoder *st, 
    int request,
    opus_uint32 *value))


IPPAPI(int, ippsIntel_opus_decoder_init, (
    OpusDecoder *st,
    opus_int32 Fs,
    int channels))


IPPAPI(int, ippsIntel_opus_encoder_init, (
    OpusEncoder *st,
    opus_int32 Fs,
    int channels,
    int application))

IPPAPI(int, ippsIntel_opus_encoder_get_size, (
    int channels))

IPPAPI(int, ippsIntel_opus_decoder_get_size, (
    int channels))
...
/* For ILBC API*/
#define WebRtcSpl_MemSetW16 ippsIntel_ILBC_MemSetW16
#define WebRtcSpl_MemCpyReversedOrder ippsIntel_ILBC_MemCpyReversedOrder
#define WebRtcSpl_MaxAbsValueW16 ippsIntel_ILBC_MaxAbsValueW16
#define WebRtcSpl_MaxAbsValueW32 ippsIntel_ILBC_MaxAbsValueW32
#define WebRtcSpl_MaxValueW32 ippsIntel_ILBC_MaxValueW32 
#define WebRtcSpl_MaxIndexW32 ippsIntel_ILBC_MaxIndexW32
#define WebRtcSpl_VectorBitShiftW32 ippsIntel_ILBC_VectorBitShiftW32
#define WebRtcSpl_ScaleVector ippsIntel_ILBC_ScaleVector
#define WebRtcSpl_ScaleVectorWithSat ippsIntel_ILBC_ScaleVectorWithSat
#define WebRtcSpl_ScaleAndAddVectors ippsIntel_ILBC_ScaleAndAddVectors
#define WebRtcSpl_ReverseOrderMultArrayElements ippsIntel_ILBC_ReverseOrderMultArrayElements
#define WebRtcSpl_ElementwiseVectorMult ippsIntel_ILBC_ElementwiseVectorMult
#define WebRtcSpl_AddVectorsAndShift ippsIntel_ILBC_AddVectorsAndShift
#define WebRtcSpl_AddAffineVectorToVector ippsIntel_ILBC_AddAffineVectorToVector
#define WebRtcSpl_AutoCorrelation ippsIntel_ILBC_AutoCorrelation
#define WebRtcSpl_LevinsonDurbin ippsIntel_ILBC_LevinsonDurbin
#define WebRtcSpl_CrossCorrelation ippsIntel_ILBC_CrossCorrelation
#define WebRtcSpl_SqrtFloor ippsIntel_ILBC_SqrtFloor
#define WebRtcSpl_DivW32HiLow ippsIntel_ILBC_DivW32HiLow
#define WebRtcSpl_DotProductWithScale ippsIntel_ILBC_DotProductWithScale
#define WebRtcSpl_FilterMAFastQ12 ippsIntel_ILBC_FilterMAFastQ12
#define WebRtcSpl_FilterARFastQ12 ippsIntel_ILBC_FilterARFastQ12
#define WebRtcSpl_DownsampleFast ippsIntel_ILBC_DownsampleFast
#define WebRtcIlbcfix_AugmentedCbCorr ippsIntel_ILBC_AugmentedCbCorr
#define WebRtcIlbcfix_CbMemEnergyAugmentation ippsIntel_ILBC_CbMemEnergyAugmentation
#define WebRtcIlbcfix_CbMemEnergyCalc ippsIntel_ILBC_CbMemEnergyCalc
#define WebRtcIlbcfix_CbSearchCore ippsIntel_ILBC_CbSearchCore
#define WebRtcIlbcfix_EnergyInverse ippsIntel_ILBC_EnergyInverse

#ifndef _INTEL_ILBC_API_H_
#define _INTEL_ILBC_API_H_	
//lint -save -e10 -e2
#include <stddef.h>
//lint -restore
#endif

IPPAPI(void, ippsIntel_ILBC_MemSetW16, (Ipp16s* vector,
                         Ipp16s set_value,
                         size_t vector_length))
						 
IPPAPI(void, ippsIntel_ILBC_MemCpyReversedOrder, (Ipp16s* out_vector,
                                   Ipp16s* in_vector,
                                   size_t vector_length))	
             
IPPAPI(Ipp16s, ippsIntel_ILBC_MaxAbsValueW16, (const Ipp16s* vector, size_t length))

IPPAPI(Ipp32s, ippsIntel_ILBC_MaxAbsValueW32, (const Ipp32s* vector, size_t length))

IPPAPI(Ipp32s, ippsIntel_ILBC_MaxValueW32, (const Ipp32s* vector, size_t length))

IPPAPI(size_t,  ippsIntel_ILBC_MaxIndexW32, (const Ipp32s* vector, size_t length))

IPPAPI (void, ippsIntel_ILBC_VectorBitShiftW32, (Ipp32s* out_vector,
                                 size_t vector_length,
                                 const Ipp32s* in_vector,
                                 Ipp16s right_shifts))
								 
IPPAPI(void, ippsIntel_ILBC_ScaleVector, (const Ipp16s* in_vector,
                           Ipp16s* out_vector,
                           Ipp16s gain,
                           size_t vector_length,
                           Ipp16s right_shifts))								 

IPPAPI(void, ippsIntel_ILBC_ScaleVectorWithSat, (const Ipp16s* in_vector,
                                  Ipp16s* out_vector,
                                  Ipp16s gain,
                                  size_t vector_length,
                                  Ipp16s right_shifts))
								  
IPPAPI(void, ippsIntel_ILBC_ScaleAndAddVectors, (const Ipp16s* in_vector1,
                                  Ipp16s gain1, int right_shifts1,
                                  const Ipp16s* in_vector2,
                                  Ipp16s gain2, int right_shifts2,
                                  Ipp16s* out_vector,
                                  size_t vector_length))
								  
IPPAPI(void, ippsIntel_ILBC_ReverseOrderMultArrayElements, (Ipp16s* out_vector,
                                             const Ipp16s* in_vector,
                                             const Ipp16s* window,
                                             size_t vector_length,
                                             Ipp16s right_shifts))
											 
IPPAPI(void, ippsIntel_ILBC_ElementwiseVectorMult, (Ipp16s* out_vector,
                                     const Ipp16s* in_vector,
                                     const Ipp16s* window,
                                     size_t vector_length,
                                     Ipp16s right_shifts))
									 
IPPAPI(void, ippsIntel_ILBC_AddVectorsAndShift, (Ipp16s* out_vector,
                                  const Ipp16s* in_vector1,
                                  const Ipp16s* in_vector2,
                                  size_t vector_length,
                                  Ipp16s right_shifts))
								  
IPPAPI(void, ippsIntel_ILBC_AddAffineVectorToVector, (Ipp16s* out_vector,
                                       Ipp16s* in_vector,
                                       Ipp16s gain,
                                       Ipp32s add_constant,
                                       Ipp16s right_shifts,
...
IPPAPI(size_t, ippsIntel_ILBC_AutoCorrelation, (const Ipp16s* in_vector,
                                 size_t in_vector_length,
                                 size_t order,
                                 Ipp32s* result,
                                 int* scale))
								 
IPPAPI(Ipp16s, ippsIntel_ILBC_LevinsonDurbin, (const Ipp32s* auto_corr,
                                 Ipp16s* lpc_coef,
                                 Ipp16s* refl_coef,
                                 size_t order))
								 
								 
IPPAPI(void, ippsIntel_ILBC_CrossCorrelation, (Ipp32s* cross_correlation,
                                 const Ipp16s* seq1,
                                 const Ipp16s* seq2,
                                 size_t dim_seq,
...
IPPAPI(Ipp32s, ippsIntel_ILBC_SqrtFloor, (Ipp32s value))	

IPPAPI(Ipp32s, ippsIntel_ILBC_DivW32HiLow, (Ipp32s num, Ipp16s den_hi, Ipp16s den_low))

IPPAPI(Ipp32s, ippsIntel_ILBC_DotProductWithScale, (const Ipp16s* vector1,
                                      const Ipp16s* vector2,
                                      size_t length,
                                      int scaling))
									  
IPPAPI(void, ippsIntel_ILBC_FilterMAFastQ12, (const Ipp16s* in_vector,
                               Ipp16s* out_vector,
                               const Ipp16s* ma_coef,
                               size_t ma_coef_length,
                               size_t vector_length))
							   
IPPAPI(void, ippsIntel_ILBC_FilterARFastQ12, (const Ipp16s* data_in,
                               Ipp16s* data_out,
                               const Ipp16s* __restrict coefficients,
                               size_t data_length))		

							   
IPPAPI(int, ippsIntel_ILBC_DownsampleFast, (const Ipp16s* data_in,
...
IPPAPI(void, ippsIntel_ILBC_AugmentedCbCorr, (  Ipp16s *target,   
							  Ipp16s *buffer,   
                              Ipp16s *interpSamples, 
                              Ipp32s *crossDot, 
                              size_t low,    
                              size_t high,   
		                      int scale))

IPPAPI(void, ippsIntel_ILBC_CbMemEnergyAugmentation, ( Ipp16s *interpSamples, 
                              Ipp16s *CBmem,   
                              int scale,   
                              size_t base_size,  
                              Ipp16s *energyW16,  
...
IPPAPI(void, ippsIntel_ILBC_CbMemEnergyCalc, ( Ipp32s energy, 
                              size_t range,   
                              Ipp16s *ppi,   
                              Ipp16s *ppo,   
                              Ipp16s *energyW16, 
...
IPPAPI(void, ippsIntel_ILBC_CbSearchCore, ( Ipp32s *cDot,
                              size_t range,
                              Ipp16s stage,    
                              Ipp16s *inverseEnergy,  
                              Ipp16s *inverseEnergyShift,
                              Ipp32s *Crit,  
                              size_t *bestIndex,
                              Ipp32s *bestCrit,
                              Ipp16s *bestCritSh))	
							  
IPPAPI(void, ippsIntel_ILBC_EnergyInverse, ( Ipp16s *energy,
                              size_t noOfEnergies))		
...
/* For GSMHR API*/
#define GSMHR_InitializeEncode            ippsIntel_GSMHR_Encoder_Init
#define GSMHR_InitializeEdif              ippsIntel_GSMHR_Edif_Init
#define GSMHR_InitializeDecode            ippsIntel_GSMHR_Decoder_Init
#define GSMHR_Encode                      ippsIntel_GSMHR_Encoder_Exec
#define GSMHR_Edif                        ippsIntel_GSMHR_Edif_Exec
#define GSMHR_Decode                      ippsIntel_GSMHR_Decoder_Exec

#ifndef _INTEL_GSMHR_API_H_
#define _INTEL_GSMHR_API_H_

typedef struct {
    Ipp16s swDecoMode;
    Ipp16s swTAFCnt;
    Ipp32s L_PNSeed;
} Intel_GSMHR_Edif_FrameState_t;

#endif

IPPAPI(Ipp32s, ippsIntel_GSMHR_Encoder_Init, ( void *pCntxt))	
IPPAPI(void, ippsIntel_GSMHR_Edif_Init, ( Intel_GSMHR_Edif_FrameState_t *edif))	
IPPAPI(Ipp32s, ippsIntel_GSMHR_Decoder_Init, ( void *pCntxt))
IPPAPI(void, ippsIntel_GSMHR_Encoder_Exec, ( Ipp16s *pswSpeechBuff,
                                     Ipp16s *pswSpeechEncPara,
									 int giDTXon,
									 void *pCntxt))
IPPAPI(void, ippsIntel_GSMHR_Edif_Exec, ( Ipp16s *pswSpeechEncPara,
                                     Ipp16s *pswSpeechDecPara,
									 Ipp16s swBfiDtx,
									 Intel_GSMHR_Edif_FrameState_t *edif,
									 Ipp16s swConfig))							 
IPPAPI(void, ippsIntel_GSMHR_Decoder_Exec, ( Ipp16s *pswSpeechDecPara,
                                     Ipp16s *pswDecodedSpeechFrame,
									 void *pCntxt))									 
